    ...
    return (
        <View style={estilo.container}>
            ...
            <View>
                ...
                <TextInput style={estilo.input} placeholder="Digite a Sigla" onChangeText={setsiglaCripto} vaule={siglaCripto} />
                <TextInput style={estilo.input} placeholder="Digite o valor" onChangeText={setvalorCripto} vaule={valorCripto} />
